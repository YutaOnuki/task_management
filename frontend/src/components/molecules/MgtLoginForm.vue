<template>
  <form novalidate>
    <div class="form-item">
      ...
      <input id="email" v-model="email" type="text" autocomplete="off" placeholder="例: Mgt@domain.com" @focus="resetError">
    ...
    <div class="form-item">
      ...
      <input id="password" v-model="password" type="password" autocomplete="off" placeholder="例:xxxxxx" @focus="validation-errors">
      <ul>
    ...
    <div class="form-actions">
      <MgtButton :disabled="disableLoginAction" @click="handleClick">ログイン</MgtButton>
